    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-b from-amber-50 to-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-serif text-amber-900 mb-6">Admissions</h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-serif text-gray-900 mb-12 text-center">Application Process</h2>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <Card className="border-2 border-amber-200">
              <CardHeader>
                <CardTitle className="text-xl text-amber-900">1. Visit & Learn</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-2 border-amber-200">
              <CardHeader>
                <CardTitle className="text-xl text-amber-900">2. Submit Application</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
            ...
            <Card className="border-2 border-amber-200">
              <CardHeader>
                <CardTitle className="text-xl text-amber-900">3. Family Interview</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-serif text-gray-900 mb-8 text-center">Tuition & Financial Support</h2>

          <Card className="border-0 shadow-lg mb-8">
            <CardContent className="p-8">
              <h3 className="text-2xl font-serif text-gray-900 mb-4">Self-Determined Fee System</h3>
      ...
      <section className="py-16 bg-amber-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-serif text-amber-900 mb-6">Ready to Begin?</h2>
          <p className="text-xl text-gray-700 mb-8">Take the first step toward joining our school community.</p>
