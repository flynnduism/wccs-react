    ...
    <main className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="font-serif text-lg text-amber-800">Wildcat Canyon Community School</span>
            </Link>
            <div className="hidden md:flex space-x-8">
              <Link href="/early-childhood" className="text-amber-700 font-medium">
                Early Childhood
              </Link>
              <Link href="/lower-school" className="text-amber-600 hover:text-amber-700">
                Lower School
              </Link>
              <Link href="/middle-school" className="text-amber-600 hover:text-amber-700">
                Middle School
              </Link>
              <Link href="/admissions" className="text-amber-600 hover:text-amber-700">
                Admissions
              </Link>
              <Link href="/visit" className="text-amber-600 hover:text-amber-700">
                Visit
              </Link>
      ...
      <section className="relative bg-gradient-to-b from-sky-50 to-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-serif text-amber-800 mb-6 text-balance">Early Childhood</h1>
          <p className="text-xl text-amber-700 mb-8 text-pretty max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-amber-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-serif text-amber-800 mb-4">Sweet Pea Parent & Child</h3>
                ...
                <p className="text-sm text-amber-600 mb-4">Ages: 6 months - 3 years</p>
                <Button
                  asChild
                  variant="outline"
            ...
            <Card className="border-amber-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-serif text-amber-800 mb-4">Preschool</h3>
                <p className="text-amber-700 mb-6 leading-relaxed">
                ...
                <p className="text-sm text-amber-600 mb-4">Ages: 3-4 years</p>
                <Button
                  asChild
                  variant="outline"
                  className="border-amber-600 text-amber-600 hover:bg-amber-50 bg-transparent"
            ...
            <Card className="border-amber-200 hover:shadow-lg transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-serif text-amber-800 mb-4">Kindergarten</h3>
                <p className="text-amber-700 mb-6 leading-relaxed">
                ...
                <p className="text-sm text-amber-600 mb-4">Ages: 5-6 years</p>
                <Button
                  asChild
                  variant="outline"
                  className="border-amber-600 text-amber-600 hover:bg-amber-50 bg-transparent"
      ...
      <section className="py-16 bg-sky-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-serif text-amber-800 mb-6">Our Early Childhood Philosophy</h2>
            <p className="text-lg text-amber-700 leading-relaxed text-pretty">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg border border-amber-200">
              <h3 className="text-xl font-serif text-amber-800 mb-4">Rhythm & Routine</h3>
            ...
            <div className="bg-white p-8 rounded-lg border border-amber-200">
              <h3 className="text-xl font-serif text-amber-800 mb-4">Imaginative Play</h3>
              <p className="text-amber-700 leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-lg border border-amber-200">
              <h3 className="text-xl font-serif text-amber-800 mb-4">Nature Connection</h3>
              <p className="text-amber-700 leading-relaxed">
            ...
            <div className="bg-white p-8 rounded-lg border border-amber-200">
              <h3 className="text-xl font-serif text-amber-800 mb-4">Artistic Expression</h3>
              <p className="text-amber-700 leading-relaxed">
      ...
      <section className="py-16 bg-amber-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-serif text-amber-800 mb-6">Ready to Learn More?</h2>
          <p className="text-lg text-amber-700 mb-8 text-pretty">
