...
export default function ProgramsPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-b from-sky-100 to-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-serif text-gray-900 mb-6">Our Programs</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="p-6">
                <h3 className="text-2xl font-serif text-gray-900 mb-4">Early Childhood</h3>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="p-6">
                <h3 className="text-2xl font-serif text-gray-900 mb-4">Lower School</h3>
                <p className="text-gray-600 mb-4">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="p-6">
                <h3 className="text-2xl font-serif text-gray-900 mb-4">Middle School</h3>
                <p className="text-gray-600 mb-4">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-serif text-gray-900 mb-8">Additional Programs</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="border-0 shadow-md">
              <CardContent className="p-6">
                <h3 className="text-xl font-serif text-gray-900 mb-4">Sweet Pea Parent & Child</h3>
                <p className="text-gray-600 mb-4">
            ...
            <Card className="border-0 shadow-md">
              <CardContent className="p-6">
                <h3 className="text-xl font-serif text-gray-900 mb-4">After School Programs</h3>
                <p className="text-gray-600 mb-4">
                  Extended care and enrichment activities that complement our educational philosophy and support working
                  families.
                </p>
                <Button variant="outline" className="border-amber-600 text-amber-600 bg-transparent">
                  Coming Soon
