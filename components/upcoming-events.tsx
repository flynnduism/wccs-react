      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <Card className="bg-white">
            <CardHeader>
              <CardTitle className="text-2xl text-amber-800">Sweet Pea Parent & Child</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-white">
              <CardHeader>
                <CardTitle className="text-2xl text-amber-800">Announcing Canyon Fest 2025</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-slate-700 mb-4 leading-relaxed">
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <p className="text-sm text-slate-600">All proceeds will go to WCCS and our school garden program.</p>
                </div>
                <Button className="bg-amber-600 hover:bg-amber-700 text-white">Get Tickets</Button>
              </CardContent>
            </Card>
          </div>
        </div>
